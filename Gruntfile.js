module.exports = function(grunt) {
    ...
    sass: {
      build: {
        ...
        files: [{
          ...
          '<%= meta.build %>css/foundation.css': '<%= meta.assets %>css/foundation.scss',
          '<%= meta.build %>css/normalize.css': '<%= meta.assets %>css/normalize.scss',
        }]
      }
    },
    concat: {
  ...
  grunt.registerTask('build', ['clean', 'concat', 'sass', 'jade', 'copy', 'autoprefixer', 'htmlhint']);
